    ...
    return (
        <div className="aboutMe-wrapper container-fluid">
            <div className="row">
                <div className="col-6">
                    <img
                        src={`${process.env.PUBLIC_URL}/images/faces/face_aboutme.png`}
                ...
                <div className="pt-5 col-6 aboutMe-text rounded-5">
                    ...
                    <div className="mt-5 col-6 aboutMe-details">
                        ...
                        <div className="aboutMe-secondPara">
                            He holds a diploma in Arts and Theatre Management at
                            Republic Polytechnic
                        </div>

                        <div className="aboutMe-thirdPara">
                            He is currently crafting experiences in Web
                            Development in both Visual Communication Design and
                            Informatics.
                        </div>
                    </div>
